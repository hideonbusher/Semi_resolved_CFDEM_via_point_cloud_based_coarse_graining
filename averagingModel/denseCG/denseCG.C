...
defineTypeNameAndDebug(denseCG, 0);
...
) const
{
    ...
    if(weightWithWeight2) 
        FatalError << "denseCG::setScalarAverage: attempt to weight with weight2, which is not implemented" << abort(FatalError);
...
void denseCG::setVectorAverage
(
    volVectorField& field, //averagingM().UsNext()
    double**& value,   //velocities_,  (颗粒速度基于颗粒
    double**& weight, //particleWeights_,
    volScalarField& weightField, //averagingM().UsWeightField()
    double**const& mask,
    double**const& weight2,                  //allows the specification of a 2nd weight field
    bool      weightWithWeight2   //switch to activate 2nd weight field
) const
...
/*///////////////////////////////////////////////new!///////////////////////	
			    ...
			    {Pout << "index=" << index << endl;Pout << "cellI=" << cellI << endl;Pout << "field[cellI]=" << field[cellI] << endl;}
	            {Pout << "weightField[cellI]=" << weightField[cellI] << endl;}	
*/////////////////////////////////////////////////new!//////////////////////				
            }
