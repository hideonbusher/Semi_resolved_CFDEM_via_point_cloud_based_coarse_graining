...
defineTypeNameAndDebug(CGlucy12Dgidaspow, 0);
...
CGlucy12Dgidaspow::CGlucy12Dgidaspow
(
...
:
    ...
    voidfraction_(sm.mesh().lookupObject<volScalarField> (voidfractionFieldName_)),//voidfractionFieldName是读取了couplingproperties文件里的CGlucy12Dgidaspowprops定义的vodifraction场
...
void CGlucy12Dgidaspow::setForce() const
{
...
////////////////////////////////////kernal1new////////////////////////////////////////////////////////////
				...
				{
				storesubcellkernal = particleCloud_.cellIDs()[index][lyx];
				distance=mag(particleCloud_.mesh().C()[storesubcellkernal]-particleCloud_.position(index));				
					{        
					         coefficient=exp(-distance*distance/(8*ds*ds));	//change 4.14
							 Ufluidd=Ufluidd+coefficient*U_[storesubcellkernal]*voidfraction_[storesubcellkernal];
							 sumUCoefficient=sumUCoefficient+coefficient*voidfraction_[storesubcellkernal];							 

							 voidfractionn=voidfractionn+coefficient*voidfraction_[storesubcellkernal]*particleCloud_.mesh().V()[storesubcellkernal];
                             SumVol=SumVol+coefficient*particleCloud_.mesh().V()[storesubcellkernal];							 
					}
				}
				Ufluidd=(Ufluidd)/(sumUCoefficient);
				Urr=(Ufluidd)-(Us);
				voidfractionn=(voidfractionn)/(SumVol);// final version 双网格法
////////////////////////////////////kernal1new////////////////////////////////////////////////////////////	
/*//////////////////////////////////////////use particle weight new 9.19///////////////////////////////////////////////////
			    for (int lyx = 0; lyx < particleCloud_.cellsPerParticle()[index][0]; lyx++) //kernalcell是颗粒CG域占据的网格次序，storesubcellkernal才是实际的网格id
				{
				storesubcellkernal = particleCloud_.cellIDs()[index][lyx];
				Ufluidd=Ufluidd+U_[storesubcellkernal]*voidfraction_[storesubcellkernal]*particleCloud_.particleWeights()[index][lyx];
	            voidfractionn=voidfractionn+voidfraction_[storesubcellkernal]*particleCloud_.particleWeights()[index][lyx];
				}
				Urr=(Ufluidd)-(Us);
*///////////////////////////////////////////use particle weight new 9.19///////////////////////////////////////////////////
